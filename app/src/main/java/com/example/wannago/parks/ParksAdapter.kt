...
class ParksAdapter(private val places: MutableList<Places>,
                   private val onPlaceClicked: (latitude: Double, longitude: Double) -> Unit
) : RecyclerView.Adapter<ParksAdapter.ParksViewHolder>()  {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ParksAdapter.ParksViewHolder {
    ...
    inner class ParksViewHolder(val binding: PlacesListItemBinding): RecyclerView.ViewHolder(binding.root) {
